...
{
    // obtain marker LatLng
    LatLng = {
        lat: parseFloat(place.latitude),
        lng: parseFloat(place.longitude)
    };
    
    // obtain custom marker image
    var image = {
    ...
    .done(function(data, textStatus, jqXHR) {
        ...
        // convert article JSON to HTML list
        var article = "";
        
        // display first 5 article items
        for (var i in data) {
            article += "<li><a href=\"" + data[i].link + "\">" + data[i].title + "</a></li>";
        }
        
        var content = "<ul>" + article + "</ul>";
    ...
    // append marker to markers array
    markers.push(marker);
}
...
function configure()
{
    ...
    // missing dragstart eventlistener to call removeMarkers ???
